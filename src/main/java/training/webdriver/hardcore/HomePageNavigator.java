...
public class HomePageNavigator extends AbstractPage {
    ...
    public EmailPageNavigator sendEmail(){
        ...
        System.out.println("generated email name: "+emailName);

        buttonEmailEstimate.click();

        while (!inputFieldEmail.isDisplayed()) actions.sendKeys(Keys.PAGE_DOWN).perform();
        inputFieldEmail.sendKeys(emailName);

        actions.sendKeys(Keys.PAGE_DOWN).perform();
        while (!buttonSendEmail.isDisplayed()) actions.sendKeys(Keys.PAGE_DOWN).perform();
