...
public class Menu {
    ...
    public static void menuShowing(){
        ...
        if (!MenuEngine.isAssignActNameState())System.out.println("2. to assign an action name"); else System.out.println("2. " + MenuEngine.getActionNameInput()+" "+HiearDef.getHierarchyName());
