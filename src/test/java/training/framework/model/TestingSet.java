package training.framework.model;
...
public class TestingSet {
    ...
    public void setForm_number_of_instance(String form_number_of_instance) {
        this.form_number_of_instance = form_number_of_instance;
    }
    ...
    public void setForm_os_type(String form_os_type) {
        this.form_os_type = form_os_type;
    }
    ...
    public void setForm_class_type(String form_class_type) {
        this.form_class_type = form_class_type;
    }
    ...
    public void setForm_instance_series(String form_instance_series) {
        this.form_instance_series = form_instance_series;
    }
    ...
    public void setForm_instance_type(String form_instance_type) {
        this.form_instance_type = form_instance_type;
    }
    ...
    public void setForm_gpu_number(String form_gpu_number) {
        this.form_gpu_number = form_gpu_number;
    }
    ...
    public void setForm_gpu_type(String form_gpu_type) {
        this.form_gpu_type = form_gpu_type;
    }
    ...
    public void setForm_ssd_capacity(String form_ssd_capacity) {
        this.form_ssd_capacity = form_ssd_capacity;
    }
